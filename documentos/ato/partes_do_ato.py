...
def ementa_ato(informacoes_do_formulario):
    ...
    nome_da_funcao = f'{informacoes_do_formulario["nome_da_funcao"]} {descricao_da_funcao}' if informacoes_do_formulario["nome_da_funcao"][0:6] != "Outros" else descricao_da_funcao
...
def preambulo_ato(informacoes_do_formulario): 
...
# TEXTO DO ATO 
def texto_do_ato(informacoes_do_formulario):
    ...
    if informacoes_do_formulario['tipo_de_ato'] == "Nomeação de CD":
       return texto_ato['funcao']['html'].format(texto_ato['funcao']['txt_cds']['nomeacao'].format(categoria_funcional, nome_servidor, nome_da_funcao, tipo_de_funcao, ja_tem_funcao))
        ...
        return texto_ato['funcao']['html'].format(texto_ato['funcao']['txt_cds']['reconducao'].format(data_reconducao, categoria_funcional, nome_servidor, nome_da_funcao,
                                                                                                       tipo_de_funcao)) 
    # FGS    
    elif informacoes_do_formulario['tipo_de_ato'] == "Designação de FG":
